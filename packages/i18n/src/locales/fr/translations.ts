...
export default {
  ...
  support: "Support",
  forum: "Forum",
  powered_by_plane_pages: "Propulsé par Pages",
  ...
  home: {
    empty: {
      ...
      create_project: {
        ...
        description: "La plupart des choses commencent par un projet dans cet espace.",
        cta: "Commencer",
      },
      invite_team: {
  ...
  workspace_creation: {
    ...
    subheading: "Pour commencer à commencer, vous devez créer ou rejoindre un espace de travail.",
    form: {
      name: {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Bienvenue, nous sommes ravis de vous avoir parmi nous. Créez votre premier projet et suivez vos éléments de travail, et cette page se transformera en un espace qui vous aide à progresser. Les administrateurs verront également les éléments qui aident leur équipe à progresser.",
        primary_button: {
          text: "Construisez votre premier projet",
          comic: {
            title: "Tout commence par un projet",
            description:
  ...
  workspace_settings: {
    ...
    copy_key:
      "Copiez et sauvegardez cette clé secrète dans Pages. Vous ne pourrez plus voir cette clé après avoir cliqué sur Fermer. Un fichier CSV contenant la clé a été téléchargé.",
    ...
    settings: {
      ...
      api_tokens: {
        ...
        delete: {
          ...
          description:
            "Toute application utilisant ce jeton n’aura plus accès aux données de l'espace. Cette action ne peut pas être annulée.",
          success: {
            title: "Succès !",
    ...
    empty_state: {
      api_tokens: {
        ...
        description:
          "Les L'API peut être utilisée pour intégrer les données de votre espace avec n’importe quel système externe. Créez un jeton pour commencer.",
      },
      webhooks: {
  ...
  profile: {
    ...
    empty_state: {
      activity: {
        ...
        description:
          "Commencez par créer un nouvel élément de travail ! Ajoutez-y des détails et des propriétés. Explorez davantage ici pour voir votre activité.",
      },
      assigned: {
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description: "Le système archivera automatiquement les éléments de travail qui ont été complétés ou annulés.",
      ...
      "auto-close": {
        ...
        description:
          "Le système fermera automatiquement les éléments de travail qui n’ont pas été complétés ou annulés.",
    ...
    empty_state: {
      no_issues: {
        ...
        primary_button: {
          ...
          comic: {
            title: "Les éléments de travail sont les blocs de construction dans cet espace.",
            description:
              "Refondre l’interface, Renouveler l’image de marque de l’entreprise, ou Lancer le nouveau système d’injection de carburant sont des exemples d’éléments de travail qui ont probablement des sous-éléments.",
          },
        },
      },
      no_archived_issues: {
  ...
  project_page: {
    empty_state: {
      general: {
        title:
          "Rédigez une note, un document ou une base de connaissances complète. Obtenez l’aide de Galileo, l’assistant IA, pour commencer",
        description:
          "Les Pages sont un espace de réflexion. Prenez des notes de réunion, formatez-les facilement, intégrez des éléments de travail, disposez-les à l’aide d’une bibliothèque de composants, et gardez-les tous dans le contexte de votre projet. Pour faciliter la rédaction de tout document, faites appel à Galileo, l’IA, avec un raccourci ou un clic sur un bouton.",
        primary_button: {
  ...
  self_hosted_maintenance_message: {
    plane_didnt_start_up_this_could_be_because_one_or_more_plane_services_failed_to_start:
      "L'application n’a pas démarré. Cela pourrait être dû au fait qu’un ou plusieurs services ont échoué à démarrer.",
