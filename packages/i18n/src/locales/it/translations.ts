...
export default {
  ...
  support: "Supporto",
  forum: "Forum",
  powered_by_plane_pages: "Supportato da Pages",
  ...
  home: {
    empty: {
      ...
      create_project: {
        ...
        description: "La maggior parte delle cose inizia con un progetto in l'app.",
        cta: "Inizia",
      },
      invite_team: {
  ...
  workspace_creation: {
    ...
    subheading: "Per iniziare a usare l'app, devi creare o unirti a uno spazio di lavoro.",
    form: {
      name: {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Benvenuto in l'app, siamo entusiasti di averti qui. Crea il tuo primo progetto e traccia i tuoi elementi di lavoro, e questa pagina si trasformerà in uno spazio che ti aiuta a progredire. Gli amministratori vedranno anche elementi che aiutano il team a progredire.",
        primary_button: {
          text: "Crea il tuo primo progetto",
          comic: {
            title: "Tutto inizia con un progetto in l'app",
            description:
  ...
  workspace_settings: {
    ...
    copy_key:
      "Copia e salva questa chiave segreta in Pages. Non potrai vederla dopo aver cliccato Chiudi. È stato scaricato un file CSV contenente la chiave.",
    ...
    settings: {
      ...
      api_tokens: {
        ...
        delete: {
          ...
          description:
            "Qualsiasi applicazione che utilizza questo token non avrà più accesso ai dati dell'app. Questa azione non può essere annullata.",
          success: {
            title: "Successo!",
    ...
    empty_state: {
      api_tokens: {
        ...
        description:
          "Le API di l'app possono essere utilizzate per integrare i tuoi dati in l'app con qualsiasi sistema esterno. Crea un token per iniziare.",
      },
      webhooks: {
  ...
  profile: {
    ...
    empty_state: {
      activity: {
        ...
        description:
          "Inizia creando un nuovo elemento di lavoro! Aggiungi dettagli e proprietà ad esso. Esplora l'app per vedere la tua attività.",
      },
      assigned: {
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description:
          "Il sistema archivia automaticamente gli elementi di lavoro che sono stati completati o annullati.",
        duration: "Archivia automaticamente gli elementi di lavoro chiusi per",
      },
      "auto-close": {
        title: "Chiudi automaticamente gli elementi di lavoro",
        description:
          "Il sistema chiuderà automaticamente gli elementi di lavoro che non sono stati completati o annullati.",
    ...
    empty_state: {
      no_issues: {
        ...
        primary_button: {
          ...
          comic: {
            title: "Gli elementi di lavoro sono i mattoni fondamentali in l'app.",
            description:
              "Ridisegna l'interfaccia di l'app, rebranding dell'azienda o lancia il nuovo sistema di iniezione del carburante sono esempi di elementi di lavoro che probabilmente hanno sotto-elementi.",
          },
        },
      },
      no_archived_issues: {
  ...
  project_page: {
    empty_state: {
      general: {
        title:
          "Scrivi una nota, un documento o una vera e propria base di conoscenza. Fai partire Galileo, l'assistente AI di l'app, per aiutarti a iniziare",
        description:
          "Le pagine sono spazi per appunti in l'app. Prendi note durante le riunioni, formattale facilmente, inserisci elementi di lavoro, disponili usando una libreria di componenti e tienili tutti nel contesto del tuo progetto. Per velocizzare qualsiasi documento, invoca Galileo, l'IA di l'app, con una scorciatoia o con il clic di un pulsante.",
        primary_button: {
  ...
  self_hosted_maintenance_message: {
    plane_didnt_start_up_this_could_be_because_one_or_more_plane_services_failed_to_start:
      "L'applicazione non si è avviata. Questo potrebbe essere dovuto al fatto che uno o più servizi non sono riusciti ad avviarsi.",
