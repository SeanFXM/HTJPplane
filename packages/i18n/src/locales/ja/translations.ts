...
export default {
  ...
  language_setting: "ユーザーインターフェースで使用する言語を選択してください。",
  language_and_time: "言語と時間",
  first_day_of_week: "週の始まり",
  first_day_of_week_description: "アプリ内のすべてのカレンダーの表示方法が変更されます。",
  first_day_of_week_updated_successfully: "週の始まりが正常に更新されました",
  update_failed: "更新に失敗しました",
  please_try_again_later: "しばらくしてからもう一度お試しください。",
  timezone_updated_successfully: "タイムゾーンが正常に更新されました",
  failed_to_update_timezone: "タイムゾーンの更新に失敗しました",
  language_updated_successfully: "言語が正常に更新されました",
  failed_to_update_language: "言語の更新に失敗しました",
  success_exclamation: "成功！",
  error_exclamation: "エラー！",
  profile_picture_deleted_successfully: "プロフィール画像が正常に削除されました。",
  error_deleting_profile_picture: "プロフィール画像の削除中にエラーが発生しました。もう一度お試しください。",
  profile_updated_successfully: "プロフィールが正常に更新されました。",
  error_updating_profile: "プロフィールの更新中にエラーが発生しました。もう一度お試しください。",
  failed_to_process_cover_image: "カバー画像の処理に失敗しました",
  cover_image_alt: "カバー画像",
  please_enter_first_name: "名を入力してください",
  enter_your_first_name: "名を入力してください",
  enter_your_last_name: "姓を入力してください",
  enter_your_display_name: "表示名を入力してください",
  enter_your_email: "メールアドレスを入力してください",
  product_project_manager: "プロダクト/プロジェクトマネージャー",
  create_your_workspace: "ワークスペースを作成",
  all_your_work_unified: "すべての作業を一元管理。",
  enter_workspace_name: "ワークスペース名を入力",
  failed_to_sign_out: "サインアウトに失敗しました。もう一度お試しください。",
  switching: "切り替え中...",
  switch_account: "アカウントを切り替え",
  profile_setup_completed: "プロフィール設定が完了しました！",
  profile_setup_failed: "プロフィール設定に失敗しました。もう一度お試しください。",
  please_select_at_least_one_option: "少なくとも1つ選択してください",
  this_field_is_required: "この項目は必須です",
  failed: "失敗",
  failed_to_finish_onboarding: "オンボーディングを完了できませんでした。しばらくしてからもう一度お試しください。",
  all_stickies: "すべての付箋",
  add_sticky: "付箋を追加",
  your_stickies: "あなたの付箋",
  sign_out_tooltip: "サインアウト",
  workspace_illustration: "ワークスペースのイラスト",
  sign_up: "サインアップ",
  sign_in: "サインイン",
  no_authentication_methods_available: "利用可能な認証方法がありません",
  create_account_button: "アカウントを作成",
  not_authorized: "認証されていません！",
  not_workspace_member_message:
    "このワークスペースのメンバーではありません。ワークスペース管理者に連絡して招待を受けるか、保留中の招待を確認してください。",
  ...
  or: "または",
  create_your_own_workspace: "自分のワークスペースを作成",
  no_invitations_found: "招待が見つかりません",
  i_want_to_join_invited_workspaces: "招待されたワークスペースに参加したい",
  workspace_creation_disabled_alt: "ワークスペース作成は無効です",
  onboarding_roles: {
    product_manager: "プロダクトマネージャー",
    engineering_manager: "エンジニアリングマネージャー",
    designer: "デザイナー",
    developer: "デベロッパー",
    founder_executive: "創業者/経営者",
    operations_manager: "オペレーションマネージャー",
    others: "その他",
  },
  start_of_week: {
    sunday: "日曜日",
  ...
  account_settings: {
    preferences: {
      heading: "環境設定",
      description: "あなたの働き方に合わせてアプリの体験をカスタマイズします。",
    },
    profile: {
      change_email_modal: {
        title: "メールアドレスを変更",
  ...
  notification: {
    ...
    content: {
      ...
      actions: {
        marked_duplicate: "この作業項目を重複としてマークしました。",
        unmarked_duplicate: "重複マークを解除しました。",
        added_assignee: "担当者に {value} を追加しました。",
        removed_assignee: "担当者 {value} を削除しました。",
        set_start_date: "開始日を {value} に設定しました。",
        removed_start_date: "開始日を削除しました。",
        set_due_date: "期限を {value} に設定しました。",
        removed_due_date: "期限を削除しました。",
        added_label: "ラベル {value} を追加しました。",
        removed_label: "ラベル {value} を削除しました。",
        set_parent: "親作業項目を {value} に設定しました。",
        removed_parent: "親作業項目 {value} を削除しました。",
        updated_related_work_item: "関連作業項目 {value} を更新しました。",
        removed_related_work_item: "関連作業項目 {value} を削除しました。",
        updated_blocked_by_work_item: "この作業項目を {value} によってブロック中としてマークしました。",
        removed_blocked_by_work_item: "ブロック元の関連 {value} を削除しました。",
        updated_blocking_work_item: "この作業項目を {value} をブロック中としてマークしました。",
        removed_blocking_work_item: "ブロック中の関連 {value} を削除しました。",
        commented: "コメントしました。",
        commented_with_preview: "コメントしました: {value}",
        archived_work_item: "この作業項目をアーカイブしました。",
        restored_work_item: "この作業項目を復元しました。",
        created_and_assigned_to_you: "この作業項目を作成し、あなたに割り当てました。",
        uploaded_attachment: "添付ファイルを追加しました。",
        removed_attachment: "添付ファイルを削除しました。",
        updated_description: "説明を更新しました: {value}",
        set_state: "ステータスを {value} に変更しました。",
        set_priority: "優先度を {value} に変更しました。",
        updated_title: "タイトルを {value} に変更しました。",
        updated_estimate: "見積時間を {value} に変更しました。",
        added_cycle: "サイクル {value} を追加しました。",
        removed_cycle: "この作業項目をサイクル {value} から削除しました。",
        updated_cycle: "サイクルを {value} に変更しました。",
        added_module: "モジュール {value} を追加しました。",
        removed_module: "この作業項目をモジュール {value} から削除しました。",
        updated_module: "モジュールを {value} に変更しました。",
        added_link: "リンクを追加しました: {value}",
        updated_link: "リンクを更新しました: {value}",
        removed_link: "リンクを削除しました。",
        added_reaction: "リアクション {value} を追加しました。",
        removed_reaction: "リアクション {value} を削除しました。",
        voted: "投票しました。",
        removed_vote: "投票を取り消しました。",
        updated_intake_status: "受信ステータスを {value} に変更しました。",
        created_draft: "下書きを作成しました。",
        updated_draft: "下書きを更新しました。",
        deleted_draft: "下書きを削除しました。",
        deleted_work_item: "この作業項目を削除しました。",
        mentioned_you: "あなたにメンションしました。",
      },
      system_values: {
        state: {
          backlog: "未処理",
