...
export default {
  ...
  activity: "アクティビティ",
  activity_messages: {
    created_work_item: "ワークアイテムを作成しました。",
    created_work_item_via: "経由でワークアイテムを作成しました",
    deleted_work_item: "ワークアイテムを削除しました。",
    added_assignee: "担当者を追加しました ",
    removed_assignee: "担当者を削除しました ",
    uploaded_attachment: "新しい添付ファイルをアップロードしました",
    removed_attachment: "添付ファイルを削除しました",
    to: " を ",
    from: " から ",
    updated_description: "説明を更新しました",
    removed_estimate_point: "見積もりポイントを削除しました",
    set_estimate_point_to: "見積もりポイントを",
    created_issue: "作成しました",
    converted_to_epic: "を",
    to_epic: "エピックに変換しました",
    deleted_issue: "削除しました",
    converted_to_work_item: "ワークアイテムに変換しました",
    added_label: "ラベルを追加しました",
    removed_label: "ラベルを削除しました",
    added_link: "この",
    updated_link: "を更新しました",
    removed_link: "この",
    link: "リンク",
    added_to_cycle: "を追加しました",
    this_work_item: "このワークアイテム",
    to_the_cycle: "をサイクルに",
    set_cycle_to: "サイクルを",
    removed_from_cycle: "を削除しました",
    from_the_cycle: "をサイクルから",
    added_to_module: "を追加しました",
    to_the_module: "をモジュールに",
    set_module_to: "モジュールを",
    removed_from_module: "を削除しました",
    from_the_module: "をモジュールから",
    set_title_to: "タイトルを",
    of: " の ",
    for: " の ",
    removed_parent: "親を削除しました",
    set_parent_to: "親を",
    set_priority_to: "優先度を",
    set_state_to: "状態を",
    restored: "復元しました",
    archived: "アーカイブしました",
    removed_start_date: "開始日を削除しました",
    set_start_date_to: "開始日を",
    removed_due_date: "期限を削除しました",
    set_due_date_to: "期限を",
    marked_relates_to: "を関連付けました",
    relates_to: "に関連",
    removed_relation: "との関連を削除しました",
    marked_blocking: "をブロック中としてマークしました",
    is_blocking: "がワークアイテムをブロックしています",
    removed_blocking: "ブロック中のワークアイテムを削除しました",
    marked_blocked_by: "がブロックされているとマークしました",
    is_blocked_by: "にブロックされています",
    removed_blocked_by: "のブロックを削除しました",
    being_blocked_by: "にブロックされています",
    marked_duplicate_of: "を重複としてマークしました",
    as_duplicate_of: "の重複",
    removed_duplicate_of: "の重複マークを削除しました",
    as_a_duplicate_of: "の重複として",
    declined_work_item: "ワークアイテムを辞退しました",
    declined_from_intake: "インテークからこのワークアイテムを辞退しました。",
    snoozed_work_item: "ワークアイテムをスヌーズしました",
    snoozed_this: "このワークアイテムをスヌーズしました。",
    accepted_work_item: "ワークアイテムを受け入れました",
    accepted_from_intake: "インテークからこのワークアイテムを受け入れました。",
    marked_duplicate: "重複ワークアイテムとしてマークしてインテークから辞退しました。",
    updated_intake_status: "インテークワークアイテムのステータスを更新しました。",
  ...
  common: {
    ...
    select_date: "日付を選択",
    select_cycle: "サイクルを選択",
    enter_project_name: "プロジェクト名を入力",
    enter_leave_project: "「leave project」と入力",
    enter_delete_my_project: "「delete my project」と入力",
    describe_state_for_members: "メンバー向けにこのステータスを説明してください。",
    search_for_projects: "プロジェクトを検索",
    search_for_shortcuts: "ショートカットを検索",
    search_pages: "ページを検索",
    untitled: "無題",
    view_less: "折りたたむ",
    view_all: "すべて表示",
  ...
  account_settings: {
    ...
    notifications: {
      heading: "メール通知",
      description: "購読している作業項目の最新情報を受け取れます。有効にすると通知されます。",
    },
    security: {
      heading: "セキュリティ",
    },
    api_tokens: {
      heading: "個人用アクセストークン",
      description: "外部システムやアプリケーションとデータを連携するための安全なAPIトークンを生成します。",
    },
    activity: {
      heading: "アクティビティ",
      description: "すべてのプロジェクトと作業項目にわたる最近の操作や変更を確認できます。",
    },
  },
  workspace_settings: {
    label: "ワークスペース設定",
    ...
    settings: {
      ...
      billing_and_plans: {
        ...
        heading: "請求とプラン",
        description:
          "プランを選択し、サブスクリプションを管理して、ニーズの拡大に合わせて簡単にアップグレードできます。",
      },
      exports: {
        title: "エクスポート",
        exporting: "エクスポート中",
      ...
      webhooks: {
        ...
        heading: "Webhook",
        description: "プロジェクトのイベント発生時に外部サービスへの通知を自動化します。",
      },
      api_tokens: {
        title: "APIトークン",
  ...
  project_settings: {
    ...
    states: {
      heading: "状態",
      description: "作業項目の進捗を追跡するためのワークフロー状態を定義・カスタマイズします。",
    ...
    labels: {
      ...
      heading: "ラベル",
      description: "カスタムラベルを作成して作業項目を分類・整理できます",
    },
    estimates: {
      label: "見積もり",
      ...
      heading: "見積もり",
      enable_description: "チームの複雑さや作業量を伝えるのに役立ちます。",
    },
    automations: {
      label: "自動化",
      "auto-archive": {
      ...
      heading: "自動化",
      description: "自動アクションを設定してプロジェクト管理のワークフローを効率化し、手作業を減らします。",
    },
    empty_state: {
      labels: {
        title: "ラベルがまだありません",
  ...
  power_k: {
    contextual_actions: {
      page: {
        ...
        copy_url_toast_error: "ページのURLのコピー中にエラーが発生しました。",
      },
      work_item: {
        title: "作業項目のアクション",
        indicator: "作業項目",
        change_state: "ステータスを変更",
        change_priority: "優先度を変更",
        change_assignees: "担当者を割り当て",
        assign_to_me: "自分に割り当て",
        unassign_from_me: "自分の割り当てを解除",
        change_estimate: "見積もりを変更",
        add_to_cycle: "サイクルに追加",
        add_to_modules: "モジュールに追加",
        add_labels: "ラベルを追加",
        subscribe: "通知を購読",
        unsubscribe: "通知の購読を解除",
        delete: "削除",
        copy_id: "IDをコピー",
        copy_id_toast_success: "作業項目IDをクリップボードにコピーしました。",
        copy_id_toast_error: "作業項目IDのコピー中にエラーが発生しました。",
        copy_title: "タイトルをコピー",
        copy_title_toast_success: "作業項目のタイトルをクリップボードにコピーしました。",
        copy_title_toast_error: "作業項目のタイトルのコピー中にエラーが発生しました。",
        copy_url: "URLをコピー",
        copy_url_toast_success: "作業項目のURLをクリップボードにコピーしました。",
        copy_url_toast_error: "作業項目のURLのコピー中にエラーが発生しました。",
      },
      cycle: {
        title: "サイクルのアクション",
        indicator: "サイクル",
        ...
        copy_url_toast_error: "サイクルのURLのコピー中にエラーが発生しました。",
      },
      module: {
        title: "モジュールのアクション",
        indicator: "モジュール",
        add_remove_members: "メンバーの追加/削除",
        change_status: "ステータスを変更",
        add_to_favorites: "お気に入りに追加",
        remove_from_favorites: "お気に入りから削除",
        copy_url: "URLをコピー",
        copy_url_toast_success: "モジュールのURLをクリップボードにコピーしました。",
        copy_url_toast_error: "モジュールのURLのコピー中にエラーが発生しました。",
      },
    },
    creation_actions: {
      create_work_item: "新規作業項目",
      create_page: "新規ページ",
      create_view: "新規ビュー",
      create_cycle: "新規サイクル",
      create_module: "新規モジュール",
      create_project: "新規プロジェクト",
      create_workspace: "新規ワークスペース",
    },
    navigation_actions: {
      open_workspace: "ワークスペースを開く",
      nav_home: "ホームへ移動",
      nav_inbox: "受信トレイへ移動",
      nav_your_work: "自分の作業へ移動",
      nav_account_settings: "アカウント設定へ移動",
      open_project: "プロジェクトを開く",
      nav_projects_list: "プロジェクト一覧へ移動",
      nav_all_workspace_work_items: "すべての作業項目へ移動",
      ...
      nav_workspace_settings: "ワークスペース設定へ移動",
      nav_project_work_items: "作業項目へ移動",
      open_project_cycle: "サイクルを開く",
      nav_project_cycles: "サイクルへ移動",
      open_project_module: "モジュールを開く",
      nav_project_modules: "モジュールへ移動",
      open_project_view: "プロジェクトビューを開く",
      nav_project_views: "プロジェクトビューへ移動",
      nav_project_pages: "ページへ移動",
      nav_project_intake: "インテークへ移動",
      nav_project_archives: "プロジェクトのアーカイブへ移動",
      open_project_setting: "プロジェクト設定を開く",
      nav_project_settings: "プロジェクト設定へ移動",
    },
    account_actions: {
      sign_out: "サインアウト",
      workspace_invites: "ワークスペースへの招待",
    },
    miscellaneous_actions: {
      toggle_app_sidebar: "アプリのサイドバーを切り替え",
      copy_current_page_url: "現在のページのURLをコピー",
      copy_current_page_url_toast_success: "現在のページのURLをクリップボードにコピーしました。",
      copy_current_page_url_toast_error: "現在のページのURLのコピー中にエラーが発生しました。",
      focus_top_nav_search: "検索入力にフォーカス",
    },
    preferences_actions: {
      update_theme: "インターフェースのテーマを変更",
      update_timezone: "タイムゾーンを変更",
      update_start_of_week: "週の開始日を変更",
      update_language: "インターフェースの言語を変更",
      toast: {
        theme: {
          success: "テーマを更新しました。",
        ...
        timezone: {
          success: "タイムゾーンを更新しました。",
          error: "タイムゾーンの更新に失敗しました。もう一度お試しください。",
        },
        generic: {
          success: "環境設定を更新しました。",
          error: "環境設定の更新に失敗しました。もう一度お試しください。",
        },
      },
    },
    help_actions: {
      open_keyboard_shortcuts: "キーボードショートカットを開く",
      open_plane_documentation: "ドキュメントを開く",
      join_forum: "フォーラムに参加",
      report_bug: "バグを報告",
      chat_with_us: "チャットで問い合わせ",
    },
    page_placeholders: {
      default: "コマンドを入力または検索",
      open_workspace: "ワークスペースを開く",
      open_project: "プロジェクトを開く",
      open_workspace_setting: "ワークスペース設定を開く",
      open_project_cycle: "サイクルを開く",
      ...
      open_project_view: "プロジェクトビューを開く",
      open_project_setting: "プロジェクト設定を開く",
      update_work_item_state: "ステータスを変更",
      update_work_item_priority: "優先度を変更",
      update_work_item_assignee: "担当者を割り当て",
      update_work_item_estimate: "見積もりを変更",
      update_work_item_cycle: "サイクルに追加",
      update_work_item_module: "モジュールに追加",
      update_work_item_labels: "ラベルを追加",
      update_module_member: "メンバーを変更",
      update_module_status: "ステータスを変更",
      update_theme: "テーマを変更",
      update_timezone: "タイムゾーンを変更",
      update_start_of_week: "週の開始日を変更",
  ...
  unpin: "ピン留めを解除",
  preferences: "環境設定",
  settings_moved_to_preferences: "タイムゾーンと言語の設定は環境設定に移動しました。",
  go_to_preferences: "環境設定へ移動",
  settings_description:
    "アカウント、ワークスペース、プロジェクトの設定を一か所で管理できます。タブを切り替えて簡単に設定できます。",
