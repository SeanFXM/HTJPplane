...
export default {
  ...
  auth: {
    common: {
      ...
      new_to_plane: "Nowy w tej przestrzeni?",
  ...
  support: "Wsparcie",
  forum: "Forum",
  powered_by_plane_pages: "Oparte na Pages",
  ...
  home: {
    empty: {
      ...
      create_project: {
        ...
        description: "Większość rzeczy zaczyna się od projektu w tej przestrzeni.",
        cta: "Zacznij",
      },
      invite_team: {
        title: "Zaproś zespół",
    ...
    new_at_plane: {
      title: "Co nowego w tej przestrzeni",
    },
    quick_tutorial: {
  ...
  workspace_creation: {
    ...
    subheading: "Aby korzystać musisz utworzyć lub dołączyć do przestrzeni roboczej.",
    form: {
      name: {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Witaj w tej przestrzeni, cieszymy się, że jesteś. Utwórz pierwszy projekt, śledź elementy pracy, a ta strona stanie się centrum Twojego postępu. Administratorzy zobaczą tu również elementy pomocne zespołowi.",
        primary_button: {
          text: "Utwórz pierwszy projekt",
          comic: {
            title: "Wszystko zaczyna się od projektu w tej przestrzeni",
            description:
  ...
  workspace_settings: {
    ...
    copy_key:
      "Skopiuj i zapisz ten klucz w Pages. Po zamknięciu nie będzie widoczny ponownie. Plik CSV z kluczem został pobrany.",
    ...
    empty_state: {
      api_tokens: {
        ...
        description: "Używaj API, aby zintegrować przestrzeni z zewnętrznymi systemami.",
      },
      webhooks: {
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description: "System będzie automatycznie archiwizował elementy, które zostały ukończone lub anulowane.",
        duration: "Archiwizuj elementy zamknięte dłużej niż",
      },
      "auto-close": {
        title: "Automatyczne zamykanie elementów",
        description: "System będzie automatycznie zamykał elementy, które nie zostały ukończone lub anulowane.",
  ...
  self_hosted_maintenance_message: {
    plane_didnt_start_up_this_could_be_because_one_or_more_plane_services_failed_to_start:
      "Aplikacja nie uruchomiła się. Może to być spowodowane tym, że jedna lub więcej usług nie mogła się uruchomić.",
