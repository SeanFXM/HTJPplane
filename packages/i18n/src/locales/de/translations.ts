...
export default {
  ...
  support: "Support",
  forum: "Forum",
  powered_by_plane_pages: "Bereitgestellt von Pages",
  ...
  home: {
    empty: {
      ...
      create_project: {
        ...
        description: "Die meisten Dinge beginnen mit einem Projekt in diesem Arbeitsbereich.",
        cta: "Los geht’s",
      },
      invite_team: {
        title: "Team einladen",
  ...
  workspace_creation: {
    ...
    subheading: "Um zu starten, erstellen Sie einen Arbeitsbereich oder treten Sie einem bei.",
    form: {
      name: {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Willkommen! Wir freuen uns, dass Sie hier sind. Erstellen Sie Ihr erstes Projekt, verfolgen Sie Arbeitselemente und diese Seite verwandelt sich in einen Ort für Ihren Fortschritt. Administratoren sehen hier zusätzlich teamrelevante Elemente.",
        primary_button: {
  ...
  workspace_settings: {
    ...
    copy_key:
      "Kopieren Sie diesen Schlüssel und fügen Sie ihn in Pages ein. Nach dem Schließen können Sie ihn nicht mehr sehen. Eine CSV-Datei mit dem Schlüssel wurde heruntergeladen.",
    ...
    empty_state: {
      api_tokens: {
        ...
        description: "Verwenden Sie die API, um Ihre Arbeitsbereichsdaten mit externen Systemen zu integrieren.",
      },
      webhooks: {
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description:
          "Das System wird Arbeitselemente automatisch archivieren, die abgeschlossen oder abgebrochen wurden.",
        duration: "Arbeitselemente automatisch archivieren, die seit",
      },
      "auto-close": {
        title: "Arbeitselemente automatisch schließen",
        description:
          "Das System wird Arbeitselemente automatisch schließen, die nicht abgeschlossen oder abgebrochen wurden.",
  ...
  self_hosted_maintenance_message: {
    plane_didnt_start_up_this_could_be_because_one_or_more_plane_services_failed_to_start:
      "Die Anwendung ist nicht gestartet. Möglicherweise konnten ein oder mehrere Dienste nicht starten.",
