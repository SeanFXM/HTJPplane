...
export default {
  ...
  activity_messages: {
    ...
    added_assignee: "added a new assignee ",
    ...
    removed_estimate_point: "removed the estimate point",
    set_estimate_point_to: "set the estimate point to",
    created_issue: "created",
    converted_to_epic: "converted",
    to_epic: "to an epic",
    deleted_issue: "deleted",
    converted_to_work_item: "to a work item",
    added_label: "added a new label",
    removed_label: "removed the label",
    added_link: "added this",
    updated_link: "updated the",
    removed_link: "removed this",
    link: "link",
    added_to_cycle: "added",
    this_work_item: "this work item",
    to_the_cycle: "to the cycle",
    set_cycle_to: "set the cycle to",
    removed_from_cycle: "removed",
    from_the_cycle: "from the cycle",
    added_to_module: "added",
    to_the_module: "to the module",
    set_module_to: "set the module to",
    removed_from_module: "removed",
    from_the_module: "from the module",
    ...
    marked_relates_to: "marked that",
    relates_to: "relates to",
    removed_relation: "removed the relation from",
    marked_blocking: "marked",
    is_blocking: "is blocking work item",
    removed_blocking: "removed the blocking work item",
    marked_blocked_by: "marked",
    is_blocked_by: "is being blocked by",
    removed_blocked_by: "removed",
    being_blocked_by: "being blocked by work item",
    marked_duplicate_of: "marked",
    as_duplicate_of: "as duplicate of",
    removed_duplicate_of: "removed",
    as_a_duplicate_of: "as a duplicate of",
    declined_work_item: "declined work item",
    declined_from_intake: "declined this work item from intake.",
    snoozed_work_item: "snoozed work item",
    snoozed_this: "snoozed this work item.",
    accepted_work_item: "accepted work item",
    accepted_from_intake: "accepted this work item from intake.",
    marked_duplicate: "declined this work item from intake by marking a duplicate work item.",
    updated_intake_status: "updated intake work item status.",
    from_intake_by_duplicate: " from intake by marking a duplicate work item.",
    work_item_deleted: "This work item has been deleted",
    a_work_item: " a work item",
    commented_word: "commented",
  },
  ...
  first_day_of_week_description: "This will change how all calendars in your app look.",
  first_day_of_week_updated_successfully: "First day of the week updated successfully",
  ...
  error_deleting_profile_picture: "There was some error in deleting your profile picture. Please try again.",
  profile_updated_successfully: "Profile updated successfully.",
  error_updating_profile: "There was some error in updating your profile. Please try again.",
  ...
  all_your_work_unified: "All your work — unified.",
  ...
  failed: "Failed",
  failed_to_finish_onboarding: "Failed to finish onboarding, Please try again later.",
  all_stickies: "All stickies",
  add_sticky: "Add sticky",
  your_stickies: "Your stickies",
  sign_out_tooltip: "Sign out",
  workspace_illustration: "Workspace illustration",
  sign_up: "Sign up",
  sign_in: "Sign in",
  ...
  workspace_creation_disabled_no_invites:
    "You don't have any workspace invitations yet. Workspace creation has been restricted by your instance administrator. Please get an invitation from a workspace admin or administrator first, then return here to join.",
  you_are_invited: "You are invited!",
  accept_invites_to_collaborate: "Accept the invites to collaborate with your team.",
  continue_to_workspace: "Continue to workspace",
  or: "or",
  create_your_own_workspace: "Create your own workspace",
  no_invitations_found: "No Invitations found",
  i_want_to_join_invited_workspaces: "I want to join invited workspaces",
  workspace_creation_disabled_alt: "Workspace creation disabled",
  onboarding_roles: {
  ...
  home: {
    empty: {
      ...
      create_project: {
        ...
        description: "Most things start with a project in this workspace.",
        cta: "Get started",
      },
      invite_team: {
  ...
  common: {
    ...
    project_work_items_tooltip:
      "{count, plural, one {There is # work item in this project} other {There are # work items in this project}}",
    ...
    enter_leave_project: "Enter 'leave project'",
    enter_delete_my_project: "Enter 'delete my project'",
    describe_state_for_members: "Describe this state for your members.",
    search_for_projects: "Search for projects",
    search_for_shortcuts: "Search for shortcuts",
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Welcome! We're excited to have you here. Create your first project and track your work items, and this page will transform into a space that helps you progress. Admins will also see items which help their team progress.",
        primary_button: {
  ...
  workspace_settings: {
    ...
    copy_key:
      "Copy and save this secret key in Pages. You can't see this key after you hit Close. A CSV file containing the key has been downloaded.",
    ...
    settings: {
      ...
      api_tokens: {
        ...
        delete: {
          ...
          description:
            "Any application using this token will no longer have access to workspace data. This action cannot be undone.",
          success: {
            title: "Success!",
    ...
    empty_state: {
      api_tokens: {
        ...
        description:
          "The API can be used to integrate your workspace data with any external system. Create a token to get started.",
      },
      webhooks: {
  ...
  profile: {
    ...
    empty_state: {
      activity: {
        ...
        description:
          "Get started by creating a new work item! Add details and properties to it. Explore more here to see your activity.",
      },
      assigned: {
  ...
  project_cycles: {
    ...
    completed_cycles_not_editable: "Completed cycles are not editable.",
    transfer_work_items_button: "Transfer work items",
    start_date: "Start date",
    end_date: "End date",
    ...
    active_cycle: {
      ...
      chart_current_work_items: "Current work items",
      chart_ideal_work_items: "Ideal work items",
      chart_current_points: "Current points",
      chart_ideal_points: "Ideal points",
      chart_completion: "Completion",
      chart_date: "Date",
      cancelled_excluded:
        "{count} cancelled {count, plural, one {work item is} other {work items are}} excluded from this report.",
    },
    upcoming_cycle: {
    ...
    empty_state: {
      no_issues: {
        ...
        primary_button: {
          ...
          comic: {
            title: "Work items are the building blocks.",
            description:
  ...
  project_page: {
    ...
    empty_state: {
      general: {
        title: "Write a note, a doc, or a full knowledge base. Get Galileo, the AI assistant, to help you get started",
        description:
          "Pages are a space for notes and docs. Take down meeting notes, format them easily, embed work items, lay them out using a library of components, and keep them all in your project's context. To make short work of any doc, invoke Galileo, the AI assistant, with a shortcut or the click of a button.",
        primary_button: {
  ...
  notification: {
    ...
    content: {
      ...
      actions: {
        marked_duplicate: "marked this work item as a duplicate.",
        unmarked_duplicate: "removed the duplicate mark.",
        added_assignee: "added assignee {value}.",
        removed_assignee: "removed assignee {value}.",
        set_start_date: "set the start date to {value}.",
        removed_start_date: "removed the start date.",
        set_due_date: "set the due date to {value}.",
        removed_due_date: "removed the due date.",
        added_label: "added label {value}.",
        removed_label: "removed label {value}.",
        set_parent: "set the parent work item to {value}.",
        removed_parent: "removed the parent work item {value}.",
        updated_related_work_item: "updated related work item {value}.",
        removed_related_work_item: "removed related work item {value}.",
        updated_blocked_by_work_item: "marked this work item as blocked by {value}.",
        removed_blocked_by_work_item: "removed blocked-by work item {value}.",
        updated_blocking_work_item: "marked this work item as blocking {value}.",
        removed_blocking_work_item: "removed blocking work item {value}.",
        commented: "commented.",
        commented_with_preview: "commented: {value}",
        archived_work_item: "archived this work item.",
        restored_work_item: "restored this work item.",
        created_and_assigned_to_you: "created this work item and assigned it to you.",
        uploaded_attachment: "uploaded an attachment.",
        removed_attachment: "removed an attachment.",
        updated_description: "updated the description: {value}",
        set_state: "updated state to {value}.",
        set_priority: "updated priority to {value}.",
        updated_title: "updated title to {value}.",
        updated_estimate: "updated estimate to {value}.",
        added_cycle: "added cycle {value}.",
        removed_cycle: "removed this work item from cycle {value}.",
        updated_cycle: "updated cycle to {value}.",
        added_module: "added module {value}.",
        removed_module: "removed this work item from module {value}.",
        updated_module: "updated module to {value}.",
        added_link: "added a link: {value}",
        updated_link: "updated a link: {value}",
        removed_link: "removed a link.",
        added_reaction: "added reaction {value}.",
        removed_reaction: "removed reaction {value}.",
        voted: "voted.",
        removed_vote: "removed vote.",
        updated_intake_status: "updated intake status to {value}.",
        created_draft: "created a draft.",
        updated_draft: "updated the draft.",
        deleted_draft: "deleted the draft.",
        deleted_work_item: "deleted this work item.",
  ...
  self_hosted_maintenance_message: {
    plane_didnt_start_up_this_could_be_because_one_or_more_plane_services_failed_to_start:
      "The application didn't start. One or more services may have failed to start.",
