...
export default {
  ...
  support: "Destek",
  forum: "Forum",
  powered_by_plane_pages: "Pages tarafından desteklenmektedir",
  ...
  home: {
    empty: {
      ...
      create_project: {
        title: "Proje oluştur",
        description: "Çoğu şey burada bir projeyle başlar.",
        cta: "Başla",
      },
      invite_team: {
  ...
  workspace_creation: {
    ...
    subheading: "Başlamak için başlamak için bir çalışma alanı oluşturmalı veya katılmalısınız.",
    form: {
      name: {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Hoş geldiniz, sizi aramızda görmekten heyecan duyuyoruz. İlk projenizi oluşturun ve iş öğelerinizi takip edin, bu sayfa ilerlemenize yardımcı olacak bir alana dönüşecek. Yöneticiler ayrıca ekiplerinin ilerlemesine yardımcı olacak öğeler görecek.",
        primary_button: {
          text: "İlk projenizi oluşturun",
          comic: {
            title: "Her şey bir projeyle başlar",
            description:
  ...
  workspace_settings: {
    ...
    copy_key:
      "Bu gizli anahtarı Pages'e kopyalayıp kaydedin. Kapat düğmesine bastıktan sonra bu anahtarı göremezsiniz. Anahtar içeren bir CSV dosyası indirildi.",
    ...
    empty_state: {
      api_tokens: {
        ...
        description: "API'yi harici sistemlere entegre etmek için bir token oluşturun.",
      },
      webhooks: {
  ...
  profile: {
    ...
    empty_state: {
      activity: {
        ...
        description:
          "Yeni bir iş öğesi oluşturarak başlayın! Detaylar ve özellikler ekleyin. Aktivitenizi görmek için burada daha fazlasını keşfedin.",
      },
      assigned: {
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description: "Tamamlanan veya iptal edilen iş öğeleri otomatik olarak arşivlenecektir.",
        duration: "Şu süre kapalı kalan iş öğelerini otomatik arşivle",
      },
      "auto-close": {
        title: "İş öğelerini otomatik kapat",
        description: "Tamamlanmamış veya iptal edilmemiş iş öğeleri otomatik olarak kapatılacaktır.",
    ...
    empty_state: {
      no_issues: {
        ...
        primary_button: {
          ...
          comic: {
            title: "İş öğeleri yapı taşlarıdır.",
            description:
              "UI'yi yeniden tasarlamak, şirketi yeniden markalaştırmak veya yeni yakıt enjeksiyon sistemini başlatmak, muhtemelen alt iş öğeleri olan iş öğesi örnekleridir.",
          },
        },
      },
      no_archived_issues: {
  ...
  project_page: {
    empty_state: {
      general: {
        title:
          "Bir not, belge veya tam bir bilgi bankası yazın. AI asistanı Galileo'nun başlamanıza yardımcı olmasını sağlayın",
        description:
          "Sayfalar düşüncelerinizi döktüğünüz alanlardır. Toplantı notları alın, kolayca biçimlendirin, iş öğelerini yerleştirin, bir bileşen kitaplığı kullanarak düzenleyin ve hepsini proje bağlamınızda tutun. Herhangi bir belgeyi hızlıca tamamlamak için bir kısayol veya düğme ile AI asistanı Galileo'yu çağırın.",
        primary_button: {
  ...
  self_hosted_maintenance_message: {
    plane_didnt_start_up_this_could_be_because_one_or_more_plane_services_failed_to_start:
      "Uygulama başlatılamadı. Bu, bir veya daha fazla servisin başlatılamaması nedeniyle olabilir.",
