...
export const meta = () => [
  ...
  { property: "og:title", content: "Workspace Management" },
  {
    property: "og:description",
    content: "Open-source project management tool to manage work items, cycles, and product roadmaps easily",
  },
  { property: "og:url", content: "https://htjpplane-web-production.up.railway.app/" },
  { property: "og:image", content: "https://htjpplane-web-production.up.railway.app/og-image.png" },
  { property: "og:image:width", content: "1200" },
  { property: "og:image:height", content: "630" },
  { property: "og:image:alt", content: "Workspace Management" },
  { name: "twitter:site", content: "" },
  { name: "twitter:card", content: "summary_large_image" },
  { name: "twitter:image", content: "https://htjpplane-web-production.up.railway.app/og-image.png" },
  { name: "twitter:image:width", content: "1200" },
  { name: "twitter:image:height", content: "630" },
  { name: "twitter:image:alt", content: "Workspace management" },
];
  ...
  return (
    <html lang={DEFAULT_LANGUAGE}>
      <head>
        ...
        {/* Meta info for PWA */}
        <meta name="application-name" content="Workspace Management" />
