...
export const getCoreAuthenticationModesMap: (
  ...
  "unique-codes": {
    key: "unique-codes",
    name: "Unique codes",
    description: "Allow sign-in with codes sent via email. SMTP must be configured to use this method.",
  ...
  google: {
    key: "google",
    name: "Google",
    description: "Allow members to sign in with their Google accounts.",
  ...
  github: {
    key: "github",
    name: "GitHub",
    description: "Allow members to sign in with their GitHub accounts.",
    icon: (
      <img
  ...
  gitlab: {
    key: "gitlab",
    name: "GitLab",
    description: "Allow members to sign in with their GitLab accounts.",
  ...
  gitea: {
    key: "gitea",
    name: "Gitea",
    description: "Allow members to sign in with their Gitea accounts.",
